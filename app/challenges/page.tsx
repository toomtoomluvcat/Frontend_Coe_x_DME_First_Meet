  ...
  const getProblem = async (
    ...
    try {
      const res = await axios.post(
        "https://landing-coe-x-dme.onrender.com/problem",
        formData
      );
      setProblem(res.data);
      setShowProblem(true);
        ...
        {showProblem ? (
          <div className="w-full">
            <div className="border-2 border-[#006600] bg-[#EEFFEE] w-full pb-6 ">
              <h1 className="bg-[#99CC66] text-[#006600] p-2">
                {problem?.Title}
              </h1>
            ...
            <button
              ...
              className="text-[0.9em] text-[#FFF2EB] bg-[#880000] w-fit px-4 mx-auto px-2 py-1 mt-4 flex justify-center rounded-[5px]"
            >
              กลับไปกรอกโค้ด
            </button>
          </div>
          ...
          >
            <Image
              ...
              alt="hutao"
            ></Image>
            <label className="text-[#880000] font-bold">
              กรอกโค้ดที่ได้มาจากพี่ๆ ในฐานนั้นๆ
            </label>
            <input
              type="text"
              className="focus:outline-none border-2 border-[#880000] px-2 py-1 text-[#880000]"
              value={code}
            ...
            <button
              type="submit"
              className="text-[0.9em] text-[#FFF2EB] bg-[#880000] w-fit px-4 mx-auto px-2 py-1 rounded-[5px]"
              disabled={loading}
            >
